package com.example.suixinplayer.other.videocache;

import android.content.Context;
import android.net.Uri;


import com.example.suixinplayer.other.videocache.file.DiskUsage;
import com.example.suixinplayer.other.videocache.file.FileNameGenerator;
import com.example.suixinplayer.other.videocache.file.Md5FileNameGenerator;
import com.example.suixinplayer.other.videocache.file.TotalCountLruDiskUsage;
import com.example.suixinplayer.other.videocache.file.TotalSizeLruDiskUsage;
import com.example.suixinplayer.other.videocache.headers.EmptyHeadersInjector;
import com.example.suixinplayer.other.videocache.headers.HeaderInjector;
import com.example.suixinplayer.other.videocache.sourcestorage.SourceInfoStorage;
import com.example.suixinplayer.other.videocache.sourcestorage.SourceInfoStorageFactory;
...
import static com.example.suixinplayer.other.videocache.Preconditions.checkAllNotNull;
import static com.example.suixinplayer.other.videocache.Preconditions.checkNotNull;
...
public class HttpProxyCacheServer {
     ...
     * <p>
     * Calling this method has same effect as calling with 2nd parameter set to {@code true}.
     *
    ...
    private String appendToProxyUrl(String url) {
        return String.format(Locale.CHINA, "http://%s:%d/%s", PROXY_HOST, port, ProxyCacheUtils.encode(url));
    }
