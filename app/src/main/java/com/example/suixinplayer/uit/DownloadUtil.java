...
import static com.example.suixinplayer.app.Api.STORAGE_SONG_FILE;
...
public class DownloadUtil {
    ...
    //组装下载歌曲的文件名
    public static final String getSaveSongFile(String singer,String songName){
        return singer+"-"+songName+".mp3";
    }
}
