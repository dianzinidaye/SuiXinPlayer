...
public class PopUpWindowRecyclerViewSongListAdapter extends RecyclerView.Adapter<PopUpWindowRecyclerViewSongListAdapter.VH>{
    ...
    public PopUpWindowRecyclerViewSongListAdapter(Context context, SongSearchForResultListBean.DataBean.InfoBean infoBean){
        mContext = context;
        this.infoBean = infoBean;
       DBUtil.getDBTablesList(mContext, list);
    }
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SQLiteDatabase db = DBUtil.creatDatabase("歌单", mContext);
